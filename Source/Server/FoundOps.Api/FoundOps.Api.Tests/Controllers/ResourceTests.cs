...
namespace FoundOps.Api.Tests.Controllers
{
    ...
    public class ResourceTests
    {
        ...
        protected readonly CoreEntitiesContainer CoreEntitiesContainerLive;

        private readonly Guid _roleIdLocal;
        private readonly Guid _roleIdLive;

        private readonly Guid _gotGreaseIdLive = new Guid("303C0FBC-B19F-481F-BA7A-DAA77BCD0BC1");
        ...
        public ResourceTests()
        {
            ...
            CoreEntitiesContainerLive = new CoreEntitiesContainer(ConnectionString);
            CoreEntitiesContainerLive.ContextOptions.LazyLoadingEnabled = false;
            //Admin role on GotGrease?
            _roleIdLive = CoreEntitiesContainerLive.Roles.First(r => r.OwnerBusinessAccountId == _gotGreaseIdLive && r.RoleTypeInt == (int)RoleType.Administrator).Id;
        }
        ...
        private void DetachAllEntities()
        {
            ...
            attached = CoreEntitiesContainerLive.ObjectStateManager.GetObjectStateEntries(EntityState.Added | EntityState.Deleted | EntityState.Modified | EntityState.Unchanged);
            foreach (var objectStateEntry in attached)
                CoreEntitiesContainerLive.Detach(objectStateEntry.Entity);
        }
        ...
        public void GetServiceHolders()
        {
            using (var conn = new SqlConnection(CoreConnectionsString))
            {
                ...
                //Testing Service Provider Context
                var parameters = new DynamicParameters();
                parameters.Add("@serviceProviderIdContext", _gotGreaseIdLive);
                parameters.Add("@clientIdContext", null);
                parameters.Add("@recurringServiceIdContext", null);
        ...
        public void PropagateNewFields()
        {
            ...
            var datetimeField = new FoundOps.Core.Models.CoreEntities.NumericField
                {
                    Id = id,
                    Name = "Numeric Test",
                    Minimum = 10,
            ...
            template.Fields.Add(datetimeField);
