  ...
  mind + '}' : '{' + partial.join(',') + '}'; gap = mind; return v;
      ...
      function (a, b) {
        ...
        var prepareOptions = function (options) {
            var defaultOptions = {
                key: 'foundops',
                host: 'foundops.uservoice.com',
                widget_key: 'maYU4J6kwoDHUUVx1RbXA'
            };
            var clientOptions = { "mode": "full", "tab": { "position": "middle-right", "label": "feedback \u0026 support", "link_color": "ffffff", "inverted": false, "enabled": false, "color": "333335"} };
