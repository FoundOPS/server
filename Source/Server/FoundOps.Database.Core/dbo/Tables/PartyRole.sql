CREATE TABLE [dbo].[PartyRole] (
    ...
    CONSTRAINT [FK_PartyRole_Party] FOREIGN KEY ([MemberParties_Id]) REFERENCES [dbo].[Parties] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT [FK_PartyRole_Role] FOREIGN KEY ([RoleMembership_Id]) REFERENCES [dbo].[Roles] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION
);
