CREATE TABLE [dbo].[Locations] (
    ...
    CONSTRAINT [FK_LocationParty] FOREIGN KEY ([OwnerPartyId]) REFERENCES [dbo].[Parties] ([Id]),
    CONSTRAINT [FK_LocationParty1] FOREIGN KEY ([PartyId]) REFERENCES [dbo].[Parties] ([Id]),
