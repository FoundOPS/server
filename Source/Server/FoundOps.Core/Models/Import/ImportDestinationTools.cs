        ...
        public static List<ImportColumnType> ClientsColumnTypes
        {
            get
            {
                return new List<ImportColumnType>
                {
                   ...
                   new ImportColumnType("Email Label", DataCategory.ContactInfoEmailAddressLabel, Multiplicity.Multiple),
                   new ImportColumnType("Email", DataCategory.ContactInfoEmailAddressData, Multiplicity.Multiple),
                   new ImportColumnType("Fax Label", DataCategory.ContactInfoFaxNumberLabel, Multiplicity.Multiple),
                   new ImportColumnType("Fax", DataCategory.ContactInfoFaxNumberData, Multiplicity.Multiple),
                   new ImportColumnType("Phone Label", DataCategory.ContactInfoPhoneNumberLabel, Multiplicity.Multiple),
                   new ImportColumnType("Phone", DataCategory.ContactInfoPhoneNumberData, Multiplicity.Multiple),
