...
namespace TaskOptimizer.API
{
    ...
    public class OSMResponse
    {
        // (JON CHANGE)
        [DataMember]
        public AlternativeInstructions[] Alternative_Instructions { get; set; }

        // (JON CHANGE)
        [DataMember]
        public OSMInstruction[] Route_Instructions { get; set; }

        // (JON CHANGE)
        [DataMember]
        public Coordinate[] Via_Points { get; set; }
    ...
    {
        /// <summary>
        /// Need a public constructor (JON CHANGE)
        /// </summary>
        public Coordinate()
        {
        }
